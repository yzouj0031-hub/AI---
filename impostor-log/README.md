...
实测 1000×670 下稳定 60fps。

看得见的部分：

- **九个舱室各有一个很淡的主色**（引擎琥珀、武器室红、反应堆绿、导航蓝……），
  扫一眼就知道自己在哪，不用读房名
- **角色**有投影、球面高光、朝移动方向的护目镜，走路时轻微上下浮动
- **断电**从一层平铺的灰蒙蒙改成以你为中心的手电筒。外圈最暗 0.66，
  远处的人还看得见轮廓——`draw()` 里调这一个数就能改难度
- 任务点会呼吸，负责它的船员还活着时用那个人的颜色
